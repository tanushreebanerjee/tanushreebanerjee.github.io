...
video: 
tags: [multi-object tracking, inverse rendering, computer vision, 3D object tracking, differentiable rendering]
keywords: [inverse neural rendering, explainable tracking, 3D multi-object tracking, RGB cameras, object representations, latent space optimization, differentiable rendering pipeline]
