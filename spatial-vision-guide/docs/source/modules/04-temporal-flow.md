...
**Memory**: Large memory requirement (H × W × displacement_range).
...
**Insight**: Optical flow shows evolution: traditional methods (Lucas-Kanade, Horn-Schunck) → learned features (FlowNet) → end-to-end learning (RAFT). Learned methods now dominate.
