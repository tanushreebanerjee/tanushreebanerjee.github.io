...
**Problem**: Too much control → artifacts, quality degradation. Too little → control ignored.
...
**Problem**: Quality of generation depends on quality of control signal. Poor depth maps or edges → poor results.
