...
[Figure placeholder: SDS pipeline diagram showing 3D→2D→diffusion→gradient flow]
...
**Insight**: Differentiable rendering (rendering 3D → 2D images) enables backpropagation from 2D losses to 3D parameters.
...
- Module 7.2: 2D→3D Lifting (single image input)
